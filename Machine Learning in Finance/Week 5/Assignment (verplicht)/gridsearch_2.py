...
parameters_1 = {'kernel':('linear','linear' ), 'C':[0.5, 0.16]}
svc_1 = svm.SVC()
clf_1 = GridSearchCV(svc_1, parameters_1)
svm1 = clf_1.fit(X_train, y_train)
t_1 = clf_1.cv_results_
clf_1.best_params_
print('done svm1')


parameters_2 = {'kernel':('poly', 'poly'), 'C':[2.85, 1],'degree': [2, 3], 'gamma': [0.1, 1]}
svc_2 = svm.SVC()
...
"""
parameters_3 = {'kernel':('rbf', 'rbf'), 'C':[0.5, 1.5], 'gamma': ['scale',1]}
svc_3 = svm.SVC()
clf_3 = GridSearchCV(svc_3, parameters_3)
svm3 = clf_3.fit(X_train, y_train)
t_3 = clf_3.cv_results_
svm3_score = svm3.score(X_test, y_test)
...
parameters_4 = {'kernel':('sigmoid','sigmoid'), 'C':[0.5, 1.5],'coef0': [0, 0.1],'gamma': [0.01, 0.1]}
svc_4 = svm.SVC()
clf_4 = GridSearchCV(svc_4, parameters_4)
svm4 = clf_4.fit(X_train, y_train)
t_4 = clf_4.cv_results_
svm4_score = svm4.score(X_test, y_test)

y_pred_svm4 = svm4.predict(X_test)
MSE4 = mean_squared_error(y_test,y_pred_svm4) 
